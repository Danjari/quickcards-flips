    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex flex-1">
          <div className="hidden lg:block w-1/4 bg-indigo-100 border-r border-indigo-200 overflow-y-auto">
            <div className="p-4">
              {loading ? (
              ...
              {/* what to have the User Account at the bottom of the page */}
              <div className="absolute bottom-0 items-center p-4 bg-indigo-100 opacity-90">
                <UserButton showName={true} />
              </div>
            </div>
          </div>
