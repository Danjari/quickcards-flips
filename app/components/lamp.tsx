  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mb-10 bg-gradient-to-br from-neutral-300 to-neutral-500 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
       No More
        <br /> Wasting Time
      </motion.h1>
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        'relative flex-col items-center  overflow-hidden w-full rounded-md z-0',
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125  justify-center isolate z-0 ">
        <motion.div
